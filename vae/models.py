...
class DeepVAE(nn.Module):
    ...
    def __init__(self, image_w=200, image_h=200, latent_size=30):
        ...
        # Latent space to decoded space.
        self._decoder = nn.Sequential(
            nn.Linear(self._latent_size, 400), nn.ReLU(), nn.Linear(400, 400),
            nn.ReLU(), nn.Linear(400, 3 * self._image_w * self._image_h),
            nn.Sigmoid())
...
MODELS = {'simple': VAE, 'conv': ConvVAE, 'deep': DeepVAE}
